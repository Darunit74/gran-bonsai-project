...
import { startAddNewProduct } from '../../actions/product';
import { useForm } from '../../hooks/useForm';

export const DashboardProductCreate = () => {
    ...
    const handleForm = ( e ) => {
        ...
        dispatch(startAddNewProduct( values, file ));
        reset();
        ...
        <div className="dashboard__product-main">
            <div className="dashboard__product-box">
                <div className="dashboard__product-header">
                    <h4>Llena los campos para crear un producto.</h4>
                </div>
                <form 
